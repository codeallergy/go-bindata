...
func inATestAsset() (*asset, error) {
	path := "/Users/ashvid/go/src/github.com/codeallergy/go-bindata/testdata/in/a/test.asset"
...
func inBTestAsset() (*asset, error) {
	path := "/Users/ashvid/go/src/github.com/codeallergy/go-bindata/testdata/in/b/test.asset"
...
func inCTestAsset() (*asset, error) {
	path := "/Users/ashvid/go/src/github.com/codeallergy/go-bindata/testdata/in/c/test.asset"
...
func inTestAsset() (*asset, error) {
	path := "/Users/ashvid/go/src/github.com/codeallergy/go-bindata/testdata/in/test.asset"
	name := "in/test.asset"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
